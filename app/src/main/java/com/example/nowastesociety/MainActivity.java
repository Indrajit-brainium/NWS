                    ...
                    if (success) {
                        ...
                        for (int i = 0; i < itemArray.length(); i++) {
                            ...
                            if (itemobj.has("description"))
                                ...
                                resturantDetailsModel.setDescription("");
                            }
    ...
    public void addToCart(ResturantDetailsModel resturantDetailsModel) {
        ...
        if (CheckConnectivity.getInstance(getApplicationContext()).isOnline()) {
            ...
            try {
                ...
                params.put("deliveryPreference", "PICKUP");
                params.put("addressId", "5ef1171824b0783d8c5fea2c");
            ...
            JsonObjectRequest jsonRequest = new JsonObjectRequest(Request.Method.POST, AllUrl.PostOrder, params, response -> {
                ...
                try {
                    ...
                    if (success) {
                        ...
                        new FancyGifDialog.Builder(this)
                                ...
                                .setMessage("Food Item added to your cart")
