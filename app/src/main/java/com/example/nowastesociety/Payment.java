                    ...
                    if (success) {
                        ...
                        if (msg.equals("No card found.")){
                            ...
                            new FancyGifDialog.Builder(this)
                                    .setTitle("No Card Details Found!")
                                    .setMessage("Please add your Card Details")
                                    .setPositiveBtnText("Add Card Details")
                                    .setPositiveBtnBackground("#FF4081")
                                    .setGifResource(R.drawable.nocard)   //Pass your Gif here
                                    .isCancellable(true)
