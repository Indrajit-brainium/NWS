package com.example.nowastesociety.fragment;
...
import com.example.nowastesociety.adapter.RCVMyOrderAdapter;
...
public class MyOrderFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView rcv_order=view.findViewById(R.id.rcv_order);
        rcv_order.setLayoutManager(new LinearLayoutManager(getActivity()));
        RCVMyOrderAdapter rcvMyOrderAdapter=new RCVMyOrderAdapter();
        rcv_order.setAdapter(rcvMyOrderAdapter);
    }
}
